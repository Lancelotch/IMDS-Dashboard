...
export interface IRole {
  ...
  export interface IResponseRoleMenuList extends IResponseBody<Array<IRoleMenu>>{}
  ...
  export interface IResponseMenuSideBarList extends IResponseBody<Array<IRoleMenu>>{}
